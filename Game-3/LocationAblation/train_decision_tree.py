"""
Game-3 Decision Tree Classifier Script with Sensor Location Ablation Study
- Only uses 'dec_tree_out_1' (Game-3 setting)
    ...
    for test_loc in locations:
        ...
        for train_ratio, test_ratio in ratios:
            ...
            if X_train and X_test:
                ...
                random_state=42).fit(scaler.transform(X_train), y_train)
        ...
        for user in data_by_loc.get(test_loc, {}):
            ...
            max_features='sqrt',
            class_weight='balanced',
            random_state=42).fit(scaler.transform(X_tr), y_tr)
