...
def parse_option():
    ...
    parser.add_argument('--paired_data_root', type=str, default='./save_mmbind',
                        help='root directory containing train_skeleton_paired_AB and train_gyro_paired_AB')
    parser.add_argument('--save_name', type=str, default='',
                        help='optional override for the save directory name under save_mmbind/')
    ...
    save_dir_name = opt.save_name or "save_{}_incomplete_contrastive_weighted_{}".format(opt.dataset, opt.load_pretrain)
    opt.save_path = "./save_mmbind/{}/".format(save_dir_name)
...
def set_loader(opt):
    ...
    paired_x_train_2, paired_x_train_3, similarity = data.load_all_paired_data(opt.paired_data_root)# skeleton, gyro
