"""
Decision Tree Training Script for Cross-User HAR Privacy Analysis
...
for window_size in window_sizes:
    ...
    results_root = get_results_root("Game-1", "DT", f"Window_{window_size}")
    os.makedirs(results_root, exist_ok=True)
    cache_path = os.path.join(results_root, "user_data_decision_tree.pkl")
    # If all split folders and cache exist, skip this window size
    ...
    print(f"✅ Decision Tree training for window size {window_size} completed in {time.time() - start_time:.2f} seconds.")
