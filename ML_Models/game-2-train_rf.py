"""
Game-2 Random Forest Training Script for Cross-User HAR Privacy Analysis
...
for modality in ["accel", "gyro"]:
    for window_size in window_sizes:
        ...
        results_root = get_results_root("Game-2", "RF", modality, f"Window_{window_size}")
        ...
        print(f"✅ Random Forest training for modality {modality} window size {window_size} completed in {time.time() - start_time:.2f} seconds.")
