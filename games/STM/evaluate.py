    ...
    for model_type in models_to_train:
        ...
        try:
            if model_type in neural_models or model_type in fusion_models:
                ...
                (y_pred, accuracy, y_train_pred, train_accuracy, y_train_orig, X_train_orig, 
                 history, best_epoch_info, has_zero_recall, zero_recall_classes) = train_and_evaluate_advanced_model(
                ...
                # Save results with both train and test data
                from .models.neural_models import save_advanced_results
                results[model_type] = save_advanced_results(
                    y_pred, y_test, accuracy, y_train_pred, y_train_orig, train_accuracy,
                    None, history, model_type, 
