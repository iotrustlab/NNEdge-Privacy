...
"""
Game-2 Naive Bayes Training Script for Cross-User HAR Privacy Analysis
...
import matplotlib.pyplot as plt
import seaborn as sns
from sklearn.metrics import precision_score, recall_score, f1_score, accuracy_score, confusion_matrix, mutual_info_score
from sklearn.preprocessing import StandardScaler
from sklearn.naive_bayes import GaussianNB
import numpy as np
import pandas as pd
...
for modality in ["accel", "gyro"]:
    for window_size in window_sizes:
        ...
        results_root = get_results_root("Game-2", "NB", modality, f"Window_{window_size}")
        ...
        print(f"✅ Naive Bayes training for modality {modality} window size {window_size} completed in {time.time() - start_time:.2f} seconds.")
