"""
Game-3 Random Forest Training Script for Cross-User HAR Privacy Analysis
...
window_sizes = get_window_sizes([70, 100])
...
for window_size in window_sizes:
    ...
    results_root = get_results_root("Game-3", "RF", f"Window_{window_size}")
