...
def train_and_eval_single_run(
    ...
    **kwargs
    ...
    user_data, all_labels = load_data_for_game(game_name, DATA_ROOT, num_classes)
    ...
    if model_type in neural_models or model_type in fusion_models:
        ...
        y_pred, accuracy, history, best_epoch_info, has_zero_recall, zero_recall_classes = train_and_evaluate_advanced_model(
