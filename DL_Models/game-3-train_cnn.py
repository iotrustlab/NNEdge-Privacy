...
# --- STRICT GAME-1 LOGIC, ALL FEATURES, GAME-3 MODEL ---
import os
import re
import glob
import json
...
results_root = get_results_root("Game-3", "CNN")
...
user_cache_path = os.path.join(get_results_root("Game-3", "CNN"), "user_data_all.pkl")
...
for window_size in window_sizes:
    ...
    for n_train, n_test in split_configs:
        ...
        for idx, train_users in enumerate(combos):
            ...
            # Game-3 model architecture
            model = build_cnn((window_size, len(FEATURES)), len(le.classes_))
