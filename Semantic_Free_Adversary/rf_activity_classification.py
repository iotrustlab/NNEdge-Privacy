...
if __name__ == "__main__":
    ...
    print(train_report)
    with open(f"{RESULTS_DIR}/train_activity_classification_report_rf.txt", "w") as f:
    ...
    plt.title('Train Confusion Matrix (RF)')
    plt.xlabel('Predicted')
    plt.ylabel('True')
    plt.tight_layout()
    plt.savefig(f"{RESULTS_DIR}/train_confusion_matrix_rf.png")
    plt.close()
    print(f"Train confusion matrix saved to {RESULTS_DIR}/train_confusion_matrix_rf.png")
    ...
    y_stm_pred = clf_rf.predict(X_stm_final_std)
    report = classification_report(y_stm_final, y_stm_pred, target_names=ACTIVITY_CLASSES)
    print(report)
    with open(f"{RESULTS_DIR}/stm_activity_classification_report_rf.txt", "w") as f:
        f.write(report)
    ...
    plt.title('Test Confusion Matrix (RF)')
    plt.xlabel('Predicted')
    plt.ylabel('True')
    plt.tight_layout()
    plt.savefig(f"{RESULTS_DIR}/test_confusion_matrix_rf.png")
    plt.close()
    print(f"Test confusion matrix saved to {RESULTS_DIR}/test_confusion_matrix_rf.png")
